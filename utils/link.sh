...
# Declare Variables
BASE=/deac/generalGrp/paucaGrp/dark_mining/Panoptic-Segmentation-for-Dark-Mining
COCO=/deac/generalGrp/paucaGrp/dark_mining/UPSNet/data/coco

# Convert Coco Files
python coco_convert.py -b train #-s nonoverlapping_annotations
python coco_convert.py -b val #-s nonoverlapping_annotations
python coco_convert.py -b test #-s nonoverlapping_annotations

# Convert to Panoptic Files
python pixelMap.py -b train #-s nonoverlapping_annotations
python pixelMap.py -b val #-s nonoverlapping_annotations
python pixelMap.py -b test #-s nonoverlapping_annotations
...
ln -s $BASE/panoptic_coco_categories.json $COCO/annotations/panoptic_coco_categories.json
